[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32e23x-cmake-vscode)](https://github.com/burakenez/gd32e23x-cmake-vscode/tags/)

# GD32E23x Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32E23x Demo Suites CMake Visual Studio Code** repository! This project integrates the CMake build system with Visual Studio Code for **_[GD32E23x Demo Suites V2.6.0](https://www.gd32mcu.com/en/download)_** and **_[GD32E23x Firmware Library V2.5.0](https://www.gd32mcu.com/en/download)_**, running entirely inside a container — **no local toolchain installation needed**.
...
```bash
git clone https://github.com/burakenez/gd32e23x-cmake-vscode.git
```
...
### 2. **CMSIS/GD/GD32E23x**
- **Version:** `V2.5.0 (2026-02-04)`
- **Path:** `Drivers/CMSIS/GD/GD32E23x`
- **Source:** `GD32E23x Demo Suites V2.6.0`
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32e23x_it.h      # Interrupt handler declarations
│           │   │   │   ├── gd32e23x_libopt.h  # Library options
│           │   │   │   └── systick.h                                  # SysTick timer declarations
│           │   │   └── Src
│           │   │       ├── gd32e23x_it.c      # Interrupt service routines
│           │   │       ├── main.c                                     # Application entry point
│           │   │       ├── system_gd32e23x.c  # Clock and core initialisation
│           │   │       └── systick.c                                  # SysTick timer implementation
│           │   ├── Startup
│           │   │   └── startup_gd32e23x.s     # Reset handler and vector table
...
│           ├── Drivers
│           │   ├── BSP/GD32E230C_EVAL              # Board support package for GD32E230C_EVAL
│           │   ├── CMSIS                                 # CMSIS for Cortex-M / GD32E23x
│           │   └── GD32E23x_standard_peripheral  # Standard peripheral library
│           ├── .clang-format                # Code style rules
│           ├── CMakeLists.txt               # Top-level CMake build file
│           ├── CMakePresets.json            # Debug / Release preset definitions
│           ├── gd32e23x_flash.ld  # Linker script (memory regions)
│           └── GD32E23x.svd             # SVD file for peripheral register views
